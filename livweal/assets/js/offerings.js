...
const init_offerings_courses_top = () => {
    ...
    const $images = [
        'assets/images/bg/offerings-courses-top-480.webp',
        'assets/images/bg/offerings-courses-top-768.webp',
        'assets/images/bg/offerings-courses-top-1024.webp',
        'assets/images/bg/offerings-courses-top-1280.webp',
        'assets/images/bg/offerings-courses-top-1920.webp'
    ];
...
const init_offerings_courses_bottom = () => {
    ...
    const $images = [
        'assets/images/bg/offerings-courses-bottom-480.webp',
        'assets/images/bg/offerings-courses-bottom-768.webp',
        'assets/images/bg/offerings-courses-bottom-1024.webp',
        'assets/images/bg/offerings-courses-bottom-1280.webp',
        'assets/images/bg/offerings-courses-bottom-1920.webp'
    ];
...
const init_offerrings_retreat = () => {
    ...
    const $images = [
        'assets/images/bg/offerrings-retreat-480.webp',
        'assets/images/bg/offerrings-retreat-768.webp',
        'assets/images/bg/offerrings-retreat-1024.webp',
        'assets/images/bg/offerrings-retreat-1280.webp',
        'assets/images/bg/offerrings-retreat-1920.webp'
    ];
