...
<html lang="en">
    <head>
        ...
        })(window,document,'script','dataLayer','GTM-N6J8Q3B');</script>
        <!-- End Google Tag Manager -->
        
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-YNNBBCTHLR"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
        
          gtag('config', 'G-YNNBBCTHLR');
        </script>
        
        <meta name="facebook-domain-verification" content="zhfzfykebwfolakdf7c1hajz7acs86" />
        ...
        fbq('init', '499912966837533');
        fbq('track', 'PageView');
        </script>
        <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=499912966837533&ev=PageView&noscript=1"
        /></noscript>
        <!-- End Meta Pixel Code -->
    </head>
    <body>
    <!-- Google Tag Manager (noscript) --> 
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N6J8Q3B" 
