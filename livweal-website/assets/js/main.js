...
function init_page() {
    ...
    const set_mobile_logo_to_light = () => {
        $("#header_mobile .header-logo .menu-off").attr('src', 'https://livweal.com/wp-content/themes/livweal-website-theme/assets/images/livweal-logo-white-mobile.png');
    }
    ...
    const update_main_logo = ($version) => {
        ...
        switch($version) {
            case "dark": {
                $html = $(`<img loading="lazy" alt="livweal institute" class="green-version" src="https://livweal.com/wp-content/themes/livweal-website-theme/assets/images/livweal-logo-green-desktop.png" />`);
                break;
            }   
            case "light": {
                $html = $(`<img loading="lazy" alt="livweal institute" class="white-version" src="https://livweal.com/wp-content/themes/livweal-website-theme/assets/images/livweal-logo-white-desktop.png" />`);
                break;
            }
            default: {
                break;
